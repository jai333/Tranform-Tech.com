...
class Tenant(models.Model):
    ...
    mail_imap_host = models.CharField(max_length=255, default='imap.gmail.com', blank=True, null=True)
    mail_imap_port = models.IntegerField(default=993, blank=True, null=True)
    mail_app_password = models.CharField(max_length=255, blank=True, null=True, help_text="Encrypted or secure App Password for IMAP/SMTP sync")
    custom_field_schema = models.JSONField(default=dict, blank=True, null=True, help_text="Defines custom fields per module, e.g. {'lead': [{'name': 'Industry', 'type': 'text'}]}")
